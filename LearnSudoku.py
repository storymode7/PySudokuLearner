...
while True:
 choice=input("Enter the 2 if you found another '2', or press n to jump to next number if no more 2 present or press e to exit ")
 if choice==2:
...
while True:
 choice=input("Enter the 3 if you found another '3', or press n to jump to next number if no more 3 present or press e to exit ")
 if choice==3:
